...
namespace Adapters {
	...
	/// </summary>
	public class SpecificQuestionAnswersAdapter : BaseAdapter<Answers> {
		Activity context = null;
		IList<Answers> answers = new List<Answers>();

		public SpecificQuestionAnswersAdapter (Activity context, IList<Answers> answers) : base ()
		{
		...
		private class ViewHolder : Java.Lang.Object
		{
			...
			{
				txtQuestion.Text = data.date_created.ToString();
